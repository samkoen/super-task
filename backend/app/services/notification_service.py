...
_TASK_LABELS = {
    ...
    "task_reopened": ("משימה נפתחה מחדש", "המנהל פתח מחדש את המשימה"),
    "task_message_employee": ("שאלה על משימה", "העובד שלח הודעה וממתין לתגובה"),
    "task_message_manager": ("תשובת מנהל", "המנהל השיב בהודעה על המשימה"),

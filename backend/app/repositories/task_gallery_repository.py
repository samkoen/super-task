...
class TaskGalleryRepository:
    ...
    def create(self, **kwargs) -> TaskGalleryItem:
        row = orm.TaskGalleryItem(
            ...
            employee_can_claim=bool(kwargs.get("employee_can_claim", False)),
            min_video_seconds=kwargs.get("min_video_seconds"),
            completion_requirements=kwargs.get("completion_requirements"),
    ...
    def _to_domain(row: orm.TaskGalleryItem | None) -> TaskGalleryItem | None:
        ...
        return TaskGalleryItem(
            ...
            employee_can_claim=bool(getattr(row, "employee_can_claim", False)),
            min_video_seconds=getattr(row, "min_video_seconds", None),
            completion_requirements=getattr(row, "completion_requirements", None),
